...
export default function Campaigns() {
  return (
    ...
    <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-4">
      <div
        className={cn(
          "group overflow-hidden relative card h-80 sm:h-96 rounded-md shadow-xl mx-auto flex flex-col justify-end p-4 border border-transparent border-neutral-800",
